...
def sospecho(a,b): 
    sospechoso = []
    try:
        with open('Python/Tareas segundo semestre/Archivos/NoSospechoso.txt','x') as created:
            pass
        with open('Python/Tareas segundo semestre/Archivos/NoSospechoso.txt','r+') as ns:
